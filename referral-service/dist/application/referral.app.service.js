...
let ReferralAppService = class ReferralAppService {
    ...
    constructor(userRepo, refRepo, ledgerRepo, idem) {
        ...
        this.idem = idem;
        this.referralDomain = new referral_service_1.ReferralService(this.refRepo);
        this.commission = new commission_service_1.CommissionService(new commission_policy_1.DefaultPolicy());
    }
