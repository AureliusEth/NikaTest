  ...
  beforeEach(async () => {
    module = await Test.createTestingModule({
      ...
      providers: [
        ...
        TradesAppService,
        ReferralAppService,
        // Mock blockchain services (not needed for XP claims)
        {
          provide: EvmBlockchainService,
          useValue: {
            verifyProof: jest.fn().mockResolvedValue(true),
            updateMerkleRoot: jest.fn().mockResolvedValue('mock-tx-hash'),
            getMerkleRoot: jest.fn(),
          },
        },
        {
          provide: SvmBlockchainService,
          useValue: {
            verifyProof: jest.fn().mockResolvedValue(true),
            updateMerkleRoot: jest.fn().mockResolvedValue('mock-tx-hash'),
            getMerkleRoot: jest.fn(),
    ...
    // Update mocks to use actual merkleService after it's available
