...
/**
 * EVM Contract Interaction Hook
 * 
 * Provides functions to interact with EVM smart contracts
 */
export function useEvmContract() {
  const { account, provider, isConnected } = useEvmWallet();
